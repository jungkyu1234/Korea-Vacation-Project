...
<body>
	...
	<input type="image" class="main_image"
		src="./image/kangwon/kangwon_kyengpodae.png" width="430px" height="301px"
		onclick="location.href='introduceKyengpoDae.html'">
	<input type="image"
		...
		class="btn_bt1" name="kyengpobutggotchukje">
